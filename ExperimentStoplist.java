 ...
 *
 */
public class ExperimentStoplist {
	...
	public static void main(String[] args) {
		...
		try {
			...
			writer = new PrintWriter(new FileWriter(args[0]+".experiment_stoplist_results.sm.txt"));
				...
				for (double bi: doubles){
					...
					for(int i = 0; i < Math.pow(2,NUM_FEATURES); i++) {
						...
						for (int j=0; j < NUM_FEATURES; j++){
							writeDictionaryInput[3+j] = subSet[j];
						}
						subsetString = "uni:"+String.valueOf(uni)+"bi:"+String.valueOf(bi)+subsetString;
